...
export default defineConfig({
  ...
  env: {
    schema: {
      ...
      RAPIDAPI_KEY: envField.string({ context: 'server', access: 'secret', optional: true }),
      SUPEREMBED_PREFERRED_SERVER: envField.string({ context: 'server', access: 'secret', optional: true }),
      APPLE_CLIENT_ID: envField.string({ context: 'server', access: 'secret', optional: true }),
      APPLE_TEAM_ID: envField.string({ context: 'server', access: 'secret', optional: true }),
      APPLE_KEY_ID: envField.string({ context: 'server', access: 'secret', optional: true }),
      APPLE_PRIVATE_KEY: envField.string({ context: 'server', access: 'secret', optional: true }),
      APPLE_REDIRECT_URI: envField.string({ context: 'server', access: 'secret', optional: true }),
    },
  },
