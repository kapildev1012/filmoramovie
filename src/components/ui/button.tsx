  ...
  return (
    <button
      className={cn(
        ...
        "cursor-pointer bg-black shadow-[8px_8px_0px_var(--color-foreground)] transition-all duration-300 ease-in-out",
        // FIX: Removed incorrect translateX and used precise translateY for the "pushed" effect
        "hover:translate-y-[5px] hover:shadow-[3px_3px_0px_var(--color-foreground)]",
